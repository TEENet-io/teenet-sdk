...
func (x *GetDeploymentAddressesResponse) Reset() {
	*x = GetDeploymentAddressesResponse{}
	mi := &file_proto_appid_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetDeploymentAddressesResponse) Descriptor() ([]byte, []int) {
	return file_proto_appid_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *DeploymentInfo) Reset() {
	*x = DeploymentInfo{}
	mi := &file_proto_appid_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeploymentInfo) Descriptor() ([]byte, []int) {
	return file_proto_appid_service_proto_rawDescGZIP(), []int{4}
}
...
const file_proto_appid_service_proto_rawDesc = "" +
	...
	"\x16GetDeploymentAddresses\x12$.appid.GetDeploymentAddressesRequest\x1a%.appid.GetDeploymentAddressesResponseB\tZ\a./protob\x06proto3"
...
var file_proto_appid_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
